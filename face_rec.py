...
# # picture_of_me = face_recognition.load_image_file("khalid_ID.jpg")
# picture_of_me = cv2.imread("khalid_ID.jpg")
# picture_of_me = cv2.cvtColor(picture_of_me, cv2.COLOR_BGR2RGB)
# my_face_encoding = face_recognition.face_encodings(picture_of_me)[0]
...
# unknown_picture = face_recognition.load_image_file("khalid_2.jpg")
...
# end = time.time()
# if results[0] == True:
#		 print("It's a picture of me!", str(end-start), "seconds")
# else:
#		 print("It's not a picture of me!", str(end-start), "seconds")
